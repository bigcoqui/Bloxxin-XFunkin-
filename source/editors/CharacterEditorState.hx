...
class CharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		healthBarBG = new FlxSprite(30, FlxG.height - 75).loadGraphic(Paths.image("colorTest"));
	...
	function addSettingsUI() {
		...
		var dance_separate = new FlxUICheckBox(10, 80, null, null, "Multiple Idle Animations", 100);
		dance_separate.checked = daAnim.startsWith('bf');
		dance_separate.callback = function()
		{
			char.danceIdle = !char.danceIdle;
			updatePointerPos();
			reloadBGs();
		};
		...
		charDropDown = new FlxUIDropDownMenuCustom(10, 30, FlxUIDropDownMenuCustom.makeStrIdLabelArray([''], true), function(character:String)
		{
			...
			loadChar(!dance_separate.checked);
			updatePresence();
