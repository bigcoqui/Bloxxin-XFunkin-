...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Freaky on a Friday Night",	"We like Friday.",									'friday_night_play',	false],
		["No Longer Noob",				"Proof that you can beat Noob? Check it.",			'song1_nomiss',			false],
		["Mythbuster",					"Guest 666 was no match for you.",					'song2_nomiss',			false],
		["Increased Friendship",		"Musical bonding time is nice.",					'song3_nomiss',			false],
		["Admins...",					"OH MY GOSH YOU BEAT SHEDLETSKY!?",					'song4_nomiss',			false],
		["Done but Mid",				"How and why would you try to get this rating?",	'ur_bad',				false],
		["Perfectionist",				"I don't like getting misses or I exert effort.",	'ur_good',				false]
	];
...
class AttachedAchievement extends FlxSprite {
	...
	public function reloadAchievementImage() {
		if(Achievements.isAchievementUnlocked(tag)) {
			loadGraphic(Paths.image('achievementgrid'), true, 105, 105);
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		var achievementIcon:FlxSprite = new FlxSprite(achievementBG.x + 10, achievementBG.y + 10).loadGraphic(Paths.image('achievementgrid'), true, 105, 105);
